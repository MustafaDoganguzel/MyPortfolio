        ...
        <>
            <div className='header flex justify-between px-5 py-5'>
                ...
                <div className='flex gap-2'>
                    <button className='font-semibold flex items-center px-10 rounded-lg hover:bg-[#3730A3] hover:text-white hover:cursor-pointer '>Skills
                    </button>

                    <button className='font-semibold  flex items-center px-10  rounded-lg hover:bg-[#3730A3] hover:text-white hover:cursor-pointer'>Projects
                    </button>
